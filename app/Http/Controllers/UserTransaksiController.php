...
class UserTransaksiController extends Controller
{
    ...
    {	
        ...
        return view('user_transaksi.index' , compact('transaksis'))
    ...
    public function create()
    {
        ...
        $pegawai = Pegawai::all();
        $kurir = Kurir::all();
        return view('user_transaksi.create', compact('barang', 'pegawai', 'kurir'));
        // return $tipe_wisatas;
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user_transaksis.index')
    ...
    public function show($id)
    {
        ...
        $kurirs = Kurir::all();
        return view('user_transaksi.detail', ['Transaksi' => $transaksis, 'Barang' => $barangs, 'Pegawai' => $pegawais, 'Kurir' => $kurirs ]);
    }
